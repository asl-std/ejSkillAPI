...
/**
 * SkillAPI © 2017 com.sucy.skill.dynamic.TriggerHandler
 */
public class TriggerHandler implements Listener {
	...
	public TriggerHandler(final DynamicSkill skill, final String key, final Trigger trigger,
	...
	public void register(final SkillAPI plugin) {
		plugin.getServer().getPluginManager().registerEvent(trigger.getEvent(), this, EventPriority.HIGHEST,
				getExecutor(trigger), plugin, true);
	}
