...
/**
 * SkillAPI © 2018 com.sucy.skill.hook.WorldGuardHook
 */
	...
	public static List<String> getRegionIds(final Location loc) {
		try {
			...
			try {
				...
				return (List<String>) getApplicableRegionsMethod().invoke(
						(getRegionMethod().invoke(plugin, loc.getWorld())),
						vectorConstructor.newInstance(loc.getX(), loc.getY(), loc.getZ()));
