...
public class Title {
	...
	private static void loadClasses() throws Exception {
		...
		timesConstructor = packetTitle.getConstructor(titleSerializer, chatBaseComponent, int.class, int.class,
				int.class);
	...
	private static void send(Player player, String text, Object type, int fadeIn, int duration, int fadeOut)
			throws Exception {
