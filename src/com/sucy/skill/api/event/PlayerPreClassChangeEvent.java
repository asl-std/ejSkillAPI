...
/**
 * SkillAPI © 2018 com.sucy.skill.api.event.PlayerPreClassChangeEvent
 */
public class PlayerPreClassChangeEvent extends Event implements Cancellable {
	 ...
	 * @param previousClass previous class of the player (null if wasn't a
	 *                      profession)
	 * @param newClass      new class of the player (null if using the reset
	 *                      command)
	 */
	public PlayerPreClassChangeEvent(PlayerData playerData, PlayerClass playerClass, RPGClass previousClass,
			RPGClass newClass) {
